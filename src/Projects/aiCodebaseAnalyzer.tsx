...
const ProjectsCard1 = ({ mainTitle, label, title, content }: projectsProps) => {
  return (
    <div className="w-full md:w-[350px] min-h-[420px] border relative rounded-2xl border-slate-400 hover:border-green-500 hover:shadow-[0_0_12px_rgba(34,197,94,0.35)] flex flex-col">
      ...
      <div className="px-[18px] py-[12px] flex flex-col flex-1">
        <p className="border border-green-500 text-green-300 bg-green-500/10 text-center uppercase p-[2px] w-[100px] text-[12px] rounded-[5px] my-[10px]">{label}</p>
