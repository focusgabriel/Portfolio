...
const ProjectsCard = ({ mainTitle, label, title, content }: projectsProps) => {
  return (
    <div className="w-full md:w-[350px] min-h-[420px] rounded-[10px] border border-slate-400 hover:border-[#a596f9] relative flex flex-col">
      ...
      <div className="px-[14px] flex flex-col flex-1">
        <p className="border border-[#a596f9] text-center uppercase p-[2px] w-[100px] text-[12px] rounded-[5px] my-[10px] text-[#6a4fff]">{label}</p>
